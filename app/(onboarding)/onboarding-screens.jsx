    ...
    <SafeAreaView className="h-full">
        ...
        <View className="h-[160] pt-7 px-[16px]" style={{position:'absolute', left:0, right: 0, bottom:0}}>
           <Animated.View className="flex-row justify-center mb-7 gap-[8px]" layout={_layoutTransition}> 
            ...
            <CustomButton title={'Next'} transition={true} layout={_layoutTransition} SecondTitle='Start Riding' queue={current === 2} handlePress={current !== 2? () => autoRotate(true) : () =>   router.replace('/sign-up') } />
        </View>
    </SafeAreaView>
  )
}
